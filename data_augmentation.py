...
opt.add_argument('--src', type=str, required=True, help='input image src path')
opt.add_argument('--desc', type=str, required=True, help='output image desc path')
...
class DataAugmentation:
    ...
    def randomCrop(image):
        ...
        crop_win_size = np.random.randint(300, 400)
        random_region = (
